...
const Ordenes = () => {
  ...
  const [editingOrderId, setEditingOrderId] = useState<Id<'orders'> | undefined>(undefined);
  ...
  const handleEditOrder = (orderId: Id<'orders'>) => {
    ...
    <div>
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 mb-2">Órdenes</h1>
            ...
            <div className="text-gray-500">
              {searchTerm ? (
                ...
                <>
                  ...
                  <p className="text-gray-500 mb-4">Comienza creando tu primera orden</p>
                  <button
                    onClick={handleCreateOrder}
